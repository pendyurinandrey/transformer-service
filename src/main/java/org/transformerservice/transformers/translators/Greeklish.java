/*
 * Copied from https://github.com/nearchos/GreekTools/tree/master
 * All recent releases are broken, so it's impossible to add it as a Maven dependency.
 * Since there have been no commits for the last 2 years, it's unlikely that the author can be reached
 * to fix the bugs in the library itself.
 */
package org.transformerservice.transformers.translators;
